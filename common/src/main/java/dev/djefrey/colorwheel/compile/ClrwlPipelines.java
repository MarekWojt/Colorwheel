...
{
    public static final Identifier API_IMPL_VERT = Colorwheel.rl("internal/api_impl.vert");
    public static final Identifier API_IMPL_GEOM = Colorwheel.rl("internal/api_impl_geom.glsl");
    public static final Identifier API_IMPL_FRAG = Colorwheel.rl("internal/api_impl.frag");

    public static final Identifier IRIS_COMPAT_VERT = Colorwheel.rl("internal/iris_compat.vert");
    public static final Identifier IRIS_COMPAT_GEOM = Colorwheel.rl("internal/iris_compat_geom.glsl");
    public static final Identifier IRIS_COMPAT_FRAG = Colorwheel.rl("internal/iris_compat.frag");

    public static final Identifier INSTANCING_MAIN_VERT = Colorwheel.rl("internal/instancing/main.vert");
    public static final Identifier INSTANCING_MAIN_GEOM = Colorwheel.rl("internal/instancing/main_geom.glsl");
    public static final Identifier INSTANCING_MAIN_FRAG = Colorwheel.rl("internal/instancing/main.frag");

    public static final Identifier OIT_DEPTH_RANGE_FRAG = Colorwheel.rl("internal/oit/depth_range.frag");

    public static final Identifier COMPONENTS_HEADER_FRAG = ResourceUtil.rl("internal/components_header.frag");
