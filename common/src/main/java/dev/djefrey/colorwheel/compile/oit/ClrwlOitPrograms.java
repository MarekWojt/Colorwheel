...
import com.zurrtum.create.client.flywheel.backend.compile.core.FailedCompilation;
...
{
    private static final Identifier DEPTH = Colorwheel.rl("internal/oit/depth.frag");
